...
from app.schemas.game_session_schemas import GameSession
...
async def delete_game_session_by_game_session_id(
    game_session_id: int,
) -> GameSession: ...


@game_sessions_router.put("/{game_session_id}")
async def update_game_session_by_game_session_id(
    game_session_id: int,
) -> GameSession: ...
